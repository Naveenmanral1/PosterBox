  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        backendUrl + "/api/v1/product/add-product",
        formData,
        { headers: { token } }
      );
        ...
        <div className="flex  items-center mt-24">
          <div className=" flex flex-col w-full gap-[22px] md:px-5 ">
            <div className="flex gap-[22px] ">
              ...
              <div className="flex flex-1 gap-[22px] md:self-stretch ml-[28%] ">
                <div className="  h-full w-px bg-gray-300" />
                <div className="mx-auto w-full p-8 mt-1 rounded-lg ">
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <button
                      type="submit"
                      className="w-full bg-gray-900 text-white py-2 px-4 rounded-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2"
                    >
                      ADD
                    </button>
                  </form>
